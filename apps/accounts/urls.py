...
urlpatterns = [
    ...
    path("usuarios/<int:pk>/adquirir-trava/", views.usuario_adquirir_trava, name="usuario_adquirir_trava"),
    path("usuarios/<int:pk>/liberar-trava/", views.usuario_liberar_trava, name="usuario_liberar_trava"),
