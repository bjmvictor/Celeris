    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_superuser', models.BooleanField(default=False, help_text='Define que o usuário tem acesso total mesmo sem ter as permissões liberadas.', verbose_name='superuser status')),
                ('username', models.CharField(error_messages={'unique': 'O usuario com este mesmo usuario há existe.'}, help_text='Obrigatório, máximo de 150 caracteres. Apenas letras, números e @/./+/-/_.', max_length=150, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='username')),
                ('first_name', models.CharField(blank=True, max_length=150, verbose_name='first name')),
                ('last_name', models.CharField(blank=True, max_length=150, verbose_name='last name')),
                ('email', models.EmailField(blank=True, max_length=254, verbose_name='email address')),
                ('is_staff', models.BooleanField(default=False, help_text='Define se o usuario pode fazer login como administrador.', verbose_name='staff status')),
                ('is_active', models.BooleanField(default=True, help_text='Define se o usuário é considerado ativo.', verbose_name='active')),
                ...
                ('groups', models.ManyToManyField(blank=True, help_text='Os grupos ao qual o usuario pertence.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Permissões especcíficas para este usuário.', related_name='user_set', related_query_name='user', to='auth.permission', verbose_name='user permissions')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.AlterField(
            model_name='user',
            name='groups',
            field=models.ManyToManyField(blank=True, help_text='Os grupos aos quais este usuário pertence. Um usuário terá todas as permissões concedidas a cada um de seus grupos.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups'),
        ),
        migrations.AlterField(
            model_name='user',
            name='is_active',
            field=models.BooleanField(default=True, help_text='Define se o usuário está ativo, desmarcar esta opção em vez de remover a conta.', verbose_name='active'),
        ),
