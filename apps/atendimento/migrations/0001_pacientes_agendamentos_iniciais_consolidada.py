...
class Migration(migrations.Migration):
    ...
    replaces = [('atendimento', '0001_clinic_patient_agendamento'), ('atendimento', '0002_historico_motivo_alteracao')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cd_motivo_alteracao', models.ForeignKey(blank=True, db_column='cd_motivo_alteracao', null=True, on_delete=django.db.models.deletion.PROTECT, to='core.valorauxiliarglobal')),
            ],
            options={
