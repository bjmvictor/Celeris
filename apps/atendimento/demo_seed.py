...
class AtendimentoDemoSeedProvider:
    help = "Popula uma empresa fictícia com dados realistas para teste e homologação."

    code = "atendimento.demo_legacy"
    dependencies = ()

    def run(self, context):
        self.stdout = context.stdout
        self.style = context.style
        self.handle(
            empresa_codigo=context.company_code,
            senha_padrao=context.password,
            permitir_fora_debug=context.allow_non_debug,
        )
...
def register_seed_provider() -> None:
