...
urlpatterns = [
    ...
    path("ti/sessoes-travas/", views.sessoes_travas, name="sessoes_travas"),
    path("travas/adquirir/", views.adquirir_trava_generica, name="adquirir_trava_generica"),
    path("travas/liberar/", views.liberar_trava_generica, name="liberar_trava_generica"),
    ...
    path("configuracao/telas/reordenar/", views.system_navigation_reorder, name="system_navigation_reorder"),
    path("configuracao/modulos/novo/", views.system_module_edit, name="system_module_new"),
    path("configuracao/modulos/<int:pk>/", views.system_module_edit, name="system_module_edit"),
    path("configuracao/modulos/<int:pk>/alternar-status/", views.system_module_toggle_active, name="system_module_toggle_active"),
