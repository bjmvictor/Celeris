...
migracao_0002 = import_module("apps.core.migrations.0002_screendefinition_screenfield")
migracao_0003 = import_module("apps.core.migrations.0003_screendefinition_capabilities")
migracao_0004 = import_module("apps.core.migrations.0004_seed_clinic_erp_screens")
migracao_0005 = import_module("apps.core.migrations.0005_accent_screen_labels")
migracao_0008 = import_module("apps.core.migrations.0008_global_auxiliary_tables")
migracao_0009 = import_module("apps.core.migrations.0009_seed_city_state_auxiliary")
migracao_0010 = import_module("apps.core.migrations.0010_auxiliary_value_group")
migracao_0011 = import_module("apps.core.migrations.0011_seed_patient_auxiliaries")
migracao_0012 = import_module("apps.core.migrations.0012_seed_provider_types")
migracao_0014 = import_module("apps.core.migrations.0014_seed_tipo_prestador_conselho")
migracao_0015 = import_module("apps.core.migrations.0015_seed_erp_auxiliaries")
migracao_0016 = import_module("apps.core.migrations.0016_seed_provider_auxiliaries")
migracao_0017 = import_module("apps.core.migrations.0017_seed_global_usability_tables")
migracao_0018 = import_module("apps.core.migrations.0018_cep")
migracao_0019 = import_module("apps.core.migrations.0019_cleanup_legacy_cep_bairro_auxiliaries")
migracao_0020 = import_module("apps.core.migrations.0020_seed_idiomas")
migracao_0022 = import_module("apps.core.migrations.0022_populate_dynamic_screen_access_keys")
migracao_0023 = import_module("apps.core.migrations.0023_seed_minimum_test_auxiliary_values")
